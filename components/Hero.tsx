  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <span className="inline-block py-1 px-3 rounded-full bg-teal/10 text-teal text-sm font-semibold mb-6 border border-teal/20 animate-fade-in-up">
          🚀 Now Accepting Beta Partners
        </span>
        
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 leading-tight">
          Your Business Health, <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal to-blue-500">Delivered Daily.</span>
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          <a 
            href="#contact" 
            className="bg-teal text-ocean px-8 py-4 rounded-lg font-bold text-lg hover:bg-tealLight transition shadow-[0_0_20px_rgba(20,184,166,0.3)] text-center"
          >
            Get Your Dashboard
          </a>
          <a 
